...
| Positional Argument | Description |
| --- | --- |
| Jobfile_ID | The randomly generated numeric ID of the results files you wish to perform a GO-term analysis on. These numeric IDs are at the start of the file name for each file generated by Options1-5, and are also listed as runtime parameters inside each results file. |
| Sequences_File | The name of the file containing the protein sequences you wish to search for LCDs (in FASTA format). |
