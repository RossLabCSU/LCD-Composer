...
def get_args(arguments):
    parser = argparse.ArgumentParser(description='Identification of low-complexity domains on the basis of amino acid composition and linear dispersion', prog='CompoSer')
    
    parser.add_argument('fasta_file', help="""Your sequence file (in FASTA format).""")
    
    parser.add_argument('results_file', help="""The name of your results file [comma-separated values (.csv) format].""")
