...
<br/>
## Basic Usage
$ python CompoSer.py Sequences_File Results_File [-a <amino_acid_of_interest>] [-c <composition threshold>] [-w window size] [
...
> \>python CompoSer.py Sequences_File Results_File -a <amino_acid_of_interest>
