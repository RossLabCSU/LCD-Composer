...
def main():
    ...
    output = open('Combined_GOtermResults_ModelEukaryoticOrganisms_ALL-ISOFORMS_ProteinSampling.tsv', 'w')
    ...
    freqs_out = open('ModelEukaryoticOrganisms_Cross-Organism_GOfrequencies_ALL-ISOFORMS_ProteinSampling.csv', 'w')
...
def get_RandomGO_Results(organism, df, aa, output):
    ...
    h = open(organism + '_RandomlySampledProteins_All_Iterations_GO_RESULTS_ALL-ISOFORMS.tsv')
    header = h.readline()
