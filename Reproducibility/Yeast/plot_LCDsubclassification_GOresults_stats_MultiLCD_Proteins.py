...
def main():
    ...
    h = open('Scerevisiae_GOenrichment_LCD_Subclasses_MultiLCD_Proteins.tsv')
...
def stacked_barchart(df):
    ...
    plt.savefig('Fig 10C - LCDsubclassification_GOtermEffect_MultiLCD_Proteins.tiff', bbox_inches ='tight', dpi=600)
    plt.close()
