...
def main():
    ...
    output = open('TableS12_Scerevisiae_LCDsubclassification_GOresults_DegreeOfEnrichment_Analyses.tsv', 'w')
...
def get_sec_GOterm_degrees(aa, sec_aa):
    ...
    try:
        h = open('Scerevisiae_' + aa + '-primary_' + sec_aa + '-secondary_GO_RESULTS.tsv')
    except:
        return {}
    header = h.readline()
