...
def main():
    ...
    for line in h:
        ...
        # SKIP VIRAL PROTEOMES THAT APPEAR TO BE ERRONEOUS. BOTH OF THESE PROTEOMES CONTAIN ONLY ONE PROTEIN (WHICH CONTAINS AN LCD), THOUGH LITERATURE INDICATES THAT THESE VIRUSES ENCODE MORE THAN ONE PROTEIN.
        if proteome in ['UP000011843_306025', 'UP000202407_908070']:
            continue
...
def plotting(total_lcd_contents, lcd_contents_bytype, proteomes, life_domain):
    ...
    plt.savefig('Fig 5D - ' + life_domain + '_Top' + str(num_proteomes) + '_LCDproteins.tiff', bbox_inches='tight', dpi=600)
    plt.close()
