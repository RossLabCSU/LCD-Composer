...
def plot_diag_overlap_barplot(diag_df, pvals):
    ...
    plt.ylabel('Proportion of GO Terms\nthat Overlap', fontname='Arial', fontsize=14)
    
    fig = plt.gcf()
    fig.set_size_inches(10, 4.8)
    plt.savefig('Fig S7 - Summarized AcrossOrganism GOterm Overlap_MeanOverlapBarplot_WITH_StdDev.tiff', bbox_inches='tight', dpi=600)
    plt.close()
